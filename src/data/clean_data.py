...
def remove_outliers(
    ...
    Args:
        df (pd.DataFrame): DataFrame de entrada.
        columns (List[str]): Lista de nomes das colunas para remover outliers.
    ...
    for column in columns:
        ...
        df_clean = df_clean[df_clean[column] <= threshold]
...
def process_data(df):
    ...
    df = remove_outliers(df, columns=['income', 'reported_income'], percentile=0.9, verbose=False)
